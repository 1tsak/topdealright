...
public interface Constants {
    ...
    String PAYMENT_RAZOR = "PAYMENT_RAZOR";
    ...
    int REQUEST_CODE__RAZOR_ACTIVITY = 10008;
    int REQUEST_CODE__PAYTM_ACTIVITY = 10009;
    ...
    int RESULT_CODE__RAZOR_ACTIVITY = 20009;
    int RESULT_CODE__PAYTM_ACTIVITY= 20008;
...
//    String PRODUCT_TRENDING = "FILTERING_TRENDING";
    ...
    String PAYMENT_PAYTM = "PAYMENT_PAYTM";
}
