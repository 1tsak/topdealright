...
public class Config {
     ...
     */
    public static final String Paytm_getway = "http://topdealright.xyz/paytm/";
    public static final String APP_API_URL = "http://topdealright.xyz/index.php/";
    public static final String APP_IMAGES_URL = "http://topdealright.xyz/uploads/";
    public static final String APP_IMAGES_THUMB_URL = "http://topdealright.xyz/uploads/thumbnail/";
    // paytm constants

    public static final String M_ID = "BuIsfH45233495072773"; //Paytm Merchand Id we got it in paytm credentials
     ...
     * Policy Url
     */
    public static String POLICY_URL = "http://topdealright.xyz/policy.html";
