...
import com.panaceasoft.psstore.AutoScrollViewPager;
import com.panaceasoft.psstore.BannerAdapter;
import com.panaceasoft.psstore.Config;
import com.panaceasoft.psstore.MainActivity;
import com.panaceasoft.psstore.ModelBanner;
...
public class MainFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private static final String URL_BANNERS = "http://topdealright.xyz/oa/get_banners.php" ;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.get().bannerPager.startAutoScroll();
        binding.get().bannerPager.setInterval(5000);
        binding.get().bannerPager.setCycle(true);
        binding.get().bannerPager.setStopScrollWhenTouch(true);
...
//        binding.get().fooditm.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                categoryViewModel.productParameterHolder.catId = "cat32202028f388bccb9262e018d066fce5";
//                navigationController.navigateToHomeFilteringActivity(MainFragment.this.getActivity(), categoryViewModel.productParameterHolder, "FOOD");
//            }
//        });

        binding.get().searchBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        binding.get().searchtxt.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
...
//        });
    ...
    private void performSearch() {
        homeSearchProductViewModel.holder.search_term = binding.get().searchtxt.getText().toString().trim();
...
//            homeSearchProductViewModel.holder.overall_rating = "";
        ...
        // Set to Intent
        navigationController.navigateToHomeFilteringActivity(MainFragment.this.getActivity(), homeSearchProductViewModel.holder, null);
    }
...
//        });
    ...
    private void getBanners() {
        banners.clear();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_BANNERS,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                banners.add(new ModelBanner(banner.getString("banner_name"), banner.getString("banner_image")));
                            }

                            //creating adapter object and setting it to recyclerview
                            BannerAdapter adapter = new BannerAdapter(getActivity(), banners);
                            binding.get().bannerPager.setAdapter(adapter);
