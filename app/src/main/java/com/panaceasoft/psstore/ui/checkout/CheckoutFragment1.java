...
//    private AutoClearedValue<ProgressDialog> prgDialog;
    ...
    protected void initUIAndActions() {
        ...
        binding.get().countrySelectionView.setOnClickListener(v ->
                navigationController.navigateToSearchActivityCategoryFragment(getActivity(), Constants.COUNTRY, Constants.NO_DATA, Constants.NO_DATA, "countrydccca0397e7e3aa30d146e1b38ca0a22", userViewModel.cityId));
        ...
        binding.get().citySelectionView.setOnClickListener(v -> {
          ...
          //      psDialogMsg.showWarningDialog(getString(R.string.error_message__choose_country), getString(R.string.app__ok));
           ...
           // } else {
                navigationController.navigateToSearchActivityCategoryFragment(getActivity(), Constants.CITY, Constants.NO_DATA, Constants.NO_DATA, "countrydccca0397e7e3aa30d146e1b38ca0a22", userViewModel.cityId);
            //}
        });
    }
    ...
    void updateUserProfile() {
        ...
        User user = new User(userViewModel.user.userId,
               ...
               "West Bengal",
                ...
                new Country("countrydccca0397e7e3aa30d146e1b38ca0a22",
                        "India",
                        null, null, null, null,
                        null, null, null),
                new City(userViewModel.cityId,
                        "India",
                        "countrydccca0397e7e3aa30d146e1b38ca0a22", null, null,
