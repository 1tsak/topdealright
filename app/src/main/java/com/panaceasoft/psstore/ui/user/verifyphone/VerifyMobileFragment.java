package com.panaceasoft.psstore.ui.user.verifyphone;
...
import com.panaceasoft.psstore.databinding.FragmentVerifyMobileBinding;
                        ...
                        if (task.isSuccessful()) {
                            try {
                                ...
                                if (task.getResult() != null && task.getResult().getUser() != null) {
                                    ...
                                    Toast.makeText(getActivity(),"Firebase Authenticated",Toast.LENGTH_LONG).show();
                                }
                            } catch (Exception e1) {
